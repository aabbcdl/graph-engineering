...
- `main` is synchronized to public GitHub at `1341b790a7d4c705f5cb1cfdcc066ac1d22ce078`; the `v0.3.1` tag and GitHub Release point to that commit. The published NPM package is `graph-engineering@0.3.1` with `latest=0.3.1`.
...
- Mac Apple Silicon is the primary supported workflow. Public deterministic CI covers Ubuntu and macOS 14; Windows real-agent smoke remains an optional external gate and is not required for Mac use.
- Local verification is complete for `0.3.1`: `npm test` 302/302 (296 pass, 6 skipped), eval 45/45, specialist validation 72/72, package validation 67 files / 17 shipped `.mjs`, package smoke pass, and release-check ready.
- Release evidence is complete: CI run [33307211330](https://github.com/aabbcdl/graph-engineering/actions/runs/33307211330) passed all four Ubuntu/macOS jobs; the NPM tarball has 67 files, shasum `09e4b6ff80a89829a15c520e45b74d02652de704`, and integrity `sha512-PT7iWOA//BzNrggpgwn2/uygOqroZujv+LlfG/ZvAACaOxc4V3iSl+UFS4+nEsT7UNmCxJNHyMpy30Mx69l7uA==`; GitHub Releases [v0.3.0](https://github.com/aabbcdl/graph-engineering/releases/tag/v0.3.0) and [v0.3.1](https://github.com/aabbcdl/graph-engineering/releases/tag/v0.3.1) are published.
